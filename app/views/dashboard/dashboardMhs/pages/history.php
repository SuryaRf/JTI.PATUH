        ...
        .then(data => {
          ...
          data.submitted.forEach(report => {
            ...
            row.innerHTML = `
                    ...
                    <td class="text" style="padding-left: 15px; padding-right: 5px;">
                        <span class="badge ${getBadgeClass(report.status)} text-white">${report.status}</span>
                    </td>
                    <td class="text rounded-end" style="padding-left: 10px; padding-right: 5px;">
                        <button class="btn btn-primary py-1 px-4 fs-7 w-50 rounded-3 check" 
                                data-bs-toggle="modal" data-id="${report.id_pelanggaran}" data-status="${report.status}">
                            CHECK
                        </button>
                    </td>
                `;
          ...
          data.received.forEach(report => {
            ...
            row.innerHTML = `
                    ...
                    <td class="text" style="padding-left: 25px; padding-right: 5px;">
                        <span class="badge ${getBadgeClass(report.status)} text-white">${report.status}</span>
                    </td>
                    <td class="text rounded-end" style="padding-left: 25px; padding-right: 5px;">
                        <button class="btn btn-primary py-1 px-4 fs-7 w-50 rounded-3 check" 
                                data-bs-toggle="modal" data-id="${report.id_pelanggaran}" data-status="${report.status}">
                            CHECK
                        </button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">Surya Rahmat</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">NIM Mahasiswa Terlapor</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">2341760020</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Tingkat dan Jenis Pelanggaran</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">I - Bolos</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Waktu</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">Kamis, 14 November 2024 pukul 14:59</p>
                                    </div>
                                    <div class="mb-3">
            ...
            <div class="modal fade" id="detailModalDEF02" tabindex="-1" aria-labelledby="detailModalLabelDEF02" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Tingkat dan Jenis Pelanggaran</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">I - Tidak mengenakan identitas diri</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Waktu</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">Jumat, 15 November 2024 pukul 08:00</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Lokasi</label>
                        ...
                        <div class="d-flex justify-content-end align-items-start" style="margin-top: 8px;">
                            <button class="btn btn-primary rounded-3 me-2" style="font-size: 14px; font-weight: 600; padding: 6px 12px; width: 120px; height: 40px; margin-top: -20px; transform: translateX(-10px);" data-bs-toggle="modal" data-bs-target="#riwayatModal">Riwayat</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Tingkat dan Jenis Pelanggaran</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">IV - Mewarnai rambut berwarna punk</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="font-weight: 600px; color: #223381;">Waktu</label>
                                        <p class="form-control" style="border: 1px solid #ced4da; border-radius: 4px;">Kamis, 14 November 2024 pukul 14:59</p>
