                    ...
                    <div class="card card-custom shadow-2-strong">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="position-relative-wrapper">
                                <button class="btn btn-primary btn-lg btn-login" type="submit" onclick="window.location.href='/PBL/Project%20Web/app/views/dashboard/dashboardAdmin/pages/dashboard.php'">Login</button>
                            </div>
